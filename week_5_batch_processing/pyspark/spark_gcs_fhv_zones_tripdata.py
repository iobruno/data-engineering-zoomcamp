...
def main():
    ...
    fhv_gcs_path = getenv(
        ...
        "gs://iobruno_datalake_raw/dtc_ny_taxi_tripdata/fhv/fhv_tripdata_2019-01.parquet.snappy")

    zone_lookup_gcs_path = getenv(
        key='ZONE_LOOKUP_PATH',
        default="gs://iobruno_datalake_raw/dtc_ny_taxi_tripdata/zone_lookup/taxi_zone_lookup.csv")
    ...
    sdf.write\
        ...
        .mode("overwrite")\
        .parquet("gs://iobruno_datalake_raw/spark")
